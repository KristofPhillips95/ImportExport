...
# trade_curves = CSV.read("Results/TradeCurves//import_price_curves$(scenario)_$(country)_$(year)_CY_$(CY_ts)_$(endtime).csv",DataFrame)

#CSV.read("Results/TradeCurves/import_price_curvesNational Trends_2025_CY_2012_2400_s_true_tc_endo_invest_50.csv",DataFrame)


trade_curves = read_prices(scenario,year,CY_ts,endtime,simplified,country,target_cap_for_curves,geo_scope,100)
# trade_curves = CSV.read("Results/TradeCurves/import_price_curvesNational Trends_2025_CY_2012_2400_s_true_tc_endo_invest_50.csv",DataFrame)
...
build_isolated_investment_model!(m1,endtime,VOLL,disc_rate,simplified)
...
curves = read_prices(scenario,year,CY_ts,endtime,simplified,target_cap_for_curves,50)
...
build_single_trade_curve_investment_model!(m3,endtime,VOLL,transport_cost,disc_rate,simplified)
